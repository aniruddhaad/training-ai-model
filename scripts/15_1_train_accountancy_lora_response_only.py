...
Corrected accounting-training pipeline for C:\FinMod.
...
The script defaults to LoRA r=16, q/k/v/o, alpha=32, matching the strongest
configuration we have tested so far. Change constants below only deliberately.
"""
...
ADAPTER_DIR = BASE_DIR / "adapters" / "accountancy_lora_r16_qkvo_response_only"
